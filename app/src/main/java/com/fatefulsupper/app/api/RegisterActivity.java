...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerRole = findViewById(R.id.autoCompleteRole);

        String[] roles = {"general", "merchant"};ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.fragment_register, roles);

        spinnerRole.setAdapter(adapter);

        editTextUserId = findViewById(R.id.editText_userid_register);
...
//        editTextPhone = findViewById(R.id.editTextPhone);
    ...
    private void register() {
        ...
        // --- 呼叫 API ---
        Call<Map<String, Object>> call = apiService.register(userid, password, email, username,  role);
