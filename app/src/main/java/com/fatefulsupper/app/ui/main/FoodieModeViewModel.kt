...
class FoodieModeViewModel(application: Application) : AndroidViewModel(application), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    companion object {
        private const val TAG = "FoodieModeViewModel"
